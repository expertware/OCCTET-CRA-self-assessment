            ...
            <div class="row mb-4">
              <div class="col-12 col-sm">
                ...
                <Field
                  ...
                  class="form-control"
                  :class="{ 'border-danger': errors.contactName }"
                  id="contact-person"
                  ...
                  name="contactName"
                ></Field>
                <ErrorMessage name="contactName" class="error-message"></ErrorMessage>
              </div>
  ...
  methods: {
    ...
    EditCompany() {
      ...
      const obj = {
        ...
        ContactPersonRole: this.company.ContactPersonRole,
      }
      this.$axios
        .put(`/api/Administration/updateOrganisation`, obj)
        .then((response) => {
